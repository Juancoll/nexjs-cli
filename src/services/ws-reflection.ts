import { Project, Type, PropertyDeclaration, Decorator, ObjectLiteralExpression, StringLiteral } from 'ts-morph';
...
export class WSReflection {
    ...
    private importType(types: ITypeDescription[], type: ITypeDescription) {
