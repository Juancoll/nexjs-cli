...
export class FS {
    ...
    public static copyFile ( source: string, target: string, transform?: ( sourceFile: string, targetFile: string, content: string )=> string ): void {
    ...
    public static createFolder ( source: string ): void {
        if ( !fs.existsSync( source ) ) {
            fs.mkdirSync( source, { recursive: true } )
        }
    }

    public static removeFolder ( source: string ): void {
        rimraf.sync( source )
    }
}
