...
export class HubNotificationCredentials<TCredentials> {
    //#region [ fields ]
    ...
    on(action: () => void | Promise<void>): HubNotificationCredentials<TCredentials> {
        this._actions.push(action);
        return this;
    }
    off(): HubNotificationCredentials<TCredentials> {
        this._actions = [];
        return this;
    }
